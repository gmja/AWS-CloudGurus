...
# AppServers' Subnets association with Route Table, Private for AppServers
...
# DBServers' Subnets association with Route Table, Private for DBServers
...
# AWS, EIP and NAT Gateway, PublicSub-BastionHosts1
...
resource "aws_nat_gateway" "NGW" {
  ...
  subnet_id     = aws_subnet.PublicSub-BastionHosts[0].id
  tags = {
    Name = "NGW"
  }
}